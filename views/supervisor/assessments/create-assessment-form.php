...
<?php include(ROOT."includes/navbar.inc.php");?>
    ...
    <div class="container-fluid">
        ...
        <div class="col card-style ">
            <!--Start form-->
            <div class="container">
            <form class="row g-3 needs-validation" action="create-update-form.php" novalidate>
                <div class="row">
                    <!--start tile-->
                    ...
                    <p class="text-sm mb-20">
                        Create Assessment Form for <b><?php echo $student->getFirstName() , ' ';  echo $student->getLastName(); ?></b>
                    ...
                    <textarea class="form-control text-dark form-text" name="comment" id="" rows="3"></textarea>
                    </div>
                </div>

                <div class="">
                    <button type="submit" name="create" class="btn btn-primary float-end ml-5">Create Form</button>
                </div>
                </form>
            </div>
            <!--End form-->
